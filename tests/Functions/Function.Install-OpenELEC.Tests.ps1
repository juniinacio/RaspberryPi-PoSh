...
InModuleScope RaspberryPi-PoSh {
    ...
    Describe "Install-OpenELEC" {

        Context "installing OpenELEC" {
            ...
            It "Can install SD" {
                ...
                $file = Get-ChildItem -Path '/home/ubuntu/Downloads/' -Filter "OpenELEC-RPi2*" | Sort-Object -Property LastWriteTime -Descending | Select-Object -First 1

                Install-OpenELEC -SDDevicePath '/dev/mmcblk0' -FilePath $file.FullName -CustomSettings $customSettings
            ...
            It "Can install USB" {
                ...
                Install-OpenELEC -SDDevicePath '/dev/mmcblk0' -USBDevicePath '/dev/sdc' -FilePath $file.FullName -CustomSettings $customSettings
