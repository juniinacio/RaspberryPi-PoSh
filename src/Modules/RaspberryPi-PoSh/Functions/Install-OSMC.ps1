...
function Install-OSMC {
    ...
    param (
        ...
        [Parameter(Mandatory = $true, ParameterSetName = 'SD', HelpMessage = 'Path to the OSMC image file')]
        [Parameter(Mandatory = $true, ParameterSetName = 'USB', HelpMessage = 'Path to the OSMC image file')]
        [ValidateScript({
